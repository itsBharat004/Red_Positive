...
<div className="leftHeaderTitle">
    <div className="leftHeaderTitleUpper">REDPOSITIVE</div>
    <div className="leftHeaderTitleLower">SERVICE OPC PRIVATE LIMITED</div>
</div>
</div>

{/* leftHeaderDes */}

<div className="leftHeaderDes">
    <div className="leftHeaderDesText">BRING THE POWER</div>
    <div className="leftHeaderDesText">BACK TO LIFE....</div>
</div>

{/* bg images  */}
<img className="leftHeaderBgImg" src="https://www.redpositive.in/images/homeblur1.png" alt="not found" />
      </div>
      {/* right header */}
      <div className="rightHeader">
        <img className="rightHeaderImg"
          src="https://www.redpositive.in/images/logo_1.png"
          alt="not found"
        />
        {/* bg images  */}
<img className="rightHeaderBgImg1" src="https://www.redpositive.in/images/mainlogoblur.png" alt="not found" />
<img className="rightHeaderBgImg2" src="https://www.redpositive.in/images/polygon1.png" alt="not found" />
   
      </div>
      {/* <img src='https://www.redpositive.in/images/homeblur1.png' alt='not found'/> */}
    </div>
  );
};
